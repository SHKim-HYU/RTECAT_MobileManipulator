...
void print_vec(MM_JVec vec,string str){
	cout<<str<<":";
...
MM_JVec saturate(MM_JVec val, MM_JVec max_val){
	MM_JVec retVal = Map<MM_JVec>(val.data(), val.rows(), val.cols());
